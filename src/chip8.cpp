...
void Chip8::emulate() {
    ...
    case 0x8000: { // (0x8XYn)
        ...
        case 0x0004: {
            //  Adds VY to VX. VF is set to 1 when there is overflow, and 0 when
            //  not
        ...
        case 0x0005: {
            //  VY is subtracted from VX. VF is set to 0 when there's an
            //  underflow, and 1 when not
        ...
        case 0x0007: {
            //  Sets VX to VY minus VX. VF is set to 0 when there's an
            //  underflow, and 1 when not
        ...
        case 0x000E: {
            //  Shifts VX to the left by 1, then sets VF to 1 if the most
            //  significant bit of VX prior to that shift was set, or to 0 if it
            //  was unset
    ...
    case 0xC000: {
        ...
        //  (typically 0 to 255) and NN (0xCXNN)
    ...
    case 0xE000: {
        ...
        case 0x000E: {
            ...
            printf("V%01x: %i", (opcode & 0x0F00) >> 8,
                   V[(opcode & 0x0F00) >> 8]);
            // SDL_Event e;
        ...
        case 0x0001: {
            //  Skips the next instruction if the key stored in VX is not
            //  pressed (0xEXA1)
